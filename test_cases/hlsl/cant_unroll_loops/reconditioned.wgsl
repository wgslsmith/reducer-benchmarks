...
fn SAFE_PLUS_i32( a: i32,  b: i32) ->  i32 {
    if ((((b) > (0)) && ((a) > ((2147483647) - (b)))) || (((b) < (0)) && ((a) < ((-2147483648) - (b))))) {
        return a;
    } else {
        return (a) + (b);
    }
...
fn SAFE_TIMES_i32( a: i32,  b: i32) ->  i32 {
    if ((((a) == (-1)) && ((b) == (-2147483648))) || (((a) == (-2147483648)) && ((b) == (-1)))) {
        return a;
    }
    if (((a) > ((2147483647) / (b))) || ((a) < ((-2147483648) / (b)))) {
        return a;
    }
    return (a) * (b);
}
...
fn func_4( arg_0: Struct_4) ->  i32 {
    ...
    loop {
        ...
        switch (SAFE_PLUS_i32((((SAFE_DIVIDE_i32(-740461970, 644416424)) << ((2416892503u) + (2923454507u))) & (-737111025)) | (1423251348), reverseBits(SAFE_MOD_vec4_i32(countOneBits(SAFE_MINUS_vec4_i32(vec4<i32>(-1720311689, 1847424436, 354716776, -745216124), vec4<i32>(-612374855, -2062542008, 812035446, 48225482))), SAFE_DIVIDE_vec4_i32(countOneBits(vec4<i32>(-370494415, 1282043138, 1613198400, -1169321207)), max(vec4<i32>(876801057, -3542445, -1036100124, 1329842037), vec4<i32>(1766316141, -1341905773, 728830348, -553642772))))).x)) {
            default: {
            }
        }
    }
    let var_0 = Struct_1(vec4<u32>(957471169u, ~((clamp(1015340678u, 2937253005u, 28792945u)) * (~(2041545298u))), (select(select(vec4<u32>(1351458819u, 3559262428u, 62729942u, 2423320635u), vec4<u32>(2083711454u, 2313213746u, 3277831954u, 2973435153u), vec4<bool>(true, false, true, false)), (vec4<u32>(1642215628u, 3685868299u, 1712842183u, 2571842475u)) | (vec4<u32>(981195806u, 1996839206u, 224849153u, 3145038549u)), !(vec4<bool>(false, false, true, true))).x) << (478896609u), (3546728159u) | (min(clamp(vec4<u32>(1638743953u, 3600754883u, 90048904u, 2885160446u), vec4<u32>(3804733157u, 3611070705u, 90374434u, 3449771935u), vec4<u32>(3499848819u, 1750430514u, 2898397469u, 1879453334u)).xx, countOneBits(vec3<u32>(1937542694u, 3496056578u, 4212948153u)).yx).x)), !(!((min(-229067803, -1115287059)) >= (SAFE_PLUS_i32(-1252693279, 1495639951)))));
    let var_1 = clamp(clamp(~(~(~(vec3<i32>(-1413929204, 1901033008, -1109127856)))), (~(select(vec4<i32>(529878297, -1280936441, 2013227237, -1664663865), vec4<i32>(1832991638, -1108744561, 739215895, 698162322), var_0.b).yyw)) ^ (vec3<i32>(select(vec2<i32>(-73309009, 17970024), vec2<i32>(-52720922, 2025194158), true).x, (1004991776) ^ (1351686409), abs(vec4<i32>(670281844, 1224099180, 1567833298, 97678060)).x)), countOneBits(select(vec4<i32>(-1449894276, 330372934, 1338526501, 449365056), vec4<i32>(-1819138827, -1658721671, 1710876576, -2083286875), vec4<bool>(true, false, false, var_0.b))).yzy).yx, ((~(vec2<i32>(-1543010222, -1766594570))) >> ((~(var_0.a.yx)) ^ (~(vec2<u32>(var_0.a.x, var_0.a.x))))) | (vec2<i32>(((1271179855) >> (490160002u)) | (SAFE_TIMES_i32(1966683875, -1839879675)), 1516404024)), -((vec2<i32>(select(vec2<i32>(-1425969269, -485786147), vec2<i32>(518007643, -1172084545), var_0.b).x, (1379529975) ^ (486066971))) ^ (min(~(vec3<i32>(2117581245, 815566956, 439921688)), vec3<i32>(-1087449268, 1982400959, -1291492383)).yz)));
...
fn main() {
    ...
    switch (~(-(reverseBits(SAFE_MOD_vec4_i32(vec4<i32>(-82308774, -478222209, 1266639603, 306779986), (vec4<i32>(1687298415, -849738869, 1846644849, 1524683958)) >> (vec4<u32>(3923825820u, u_input.a, u_input.b, 2336913343u)))).x))) {
        case 1343489614: {
        }
        default: {
        }
