...
fn func_3() -> u32 {
    ...
    global2 = array<Struct_2, 28>();
    let var_0 = vec4<f32>(_wgslsmith_f_op_f32(785.0 * global0.c.b.x), global4[_wgslsmith_mod_u32(~global0.d.x, 22u)], global4[_wgslsmith_mod_u32(4294967295u, 22u)], _wgslsmith_f_op_f32(global0.c.b.x * global0.e.b.x));
    return countOneBits(u_input.c.x);
}

fn func_4(arg_0: vec3<bool>, arg_1: bool) -> u32 {
    if (_wgslsmith_mult_u32(min(~(~4294967295u), 725u), _wgslsmith_mult_u32(u_input.c.x, _wgslsmith_dot_vec2_u32(vec2<u32>(u_input.c.x, u_input.b), ~vec2<u32>(30467u, u_input.c.x)))) >= u_input.b) {
        var var_0 = _wgslsmith_f_op_vec4_f32(-vec4<f32>(_wgslsmith_f_op_f32(global4[_wgslsmith_mod_u32(_wgslsmith_dot_vec2_u32(countOneBits(u_input.c.yz), u_input.c.zy | vec2<u32>(1u, u_input.c.x)), 22u)] + _wgslsmith_f_op_f32(-_wgslsmith_f_op_f32(-11.0 * 2354.0))), global4[_wgslsmith_mod_u32(12679u, 22u)], _wgslsmith_f_op_f32(trunc(_wgslsmith_f_op_f32(_wgslsmith_f_op_f32(-global4[_wgslsmith_mod_u32(50283u, 22u)]) + _wgslsmith_f_op_f32(global0.c.b.x - 242.0)))), global0.c.b.x));
    }
    ...
    return ~(~(~_wgslsmith_sub_u32(141756u, ~global0.d.x)));
}

fn func_2(arg_0: vec4<bool>, arg_1: vec2<bool>, arg_2: vec3<bool>, arg_3: u32) -> Struct_1 {
    switch (_wgslsmith_div_i32(_wgslsmith_mod_i32(u_input.a.x, _wgslsmith_mult_i32(global0.c.c, 1)), ~_wgslsmith_sub_i32(firstTrailingBit(_wgslsmith_dot_vec3_i32(vec3<i32>(u_input.a.x, global0.b, u_input.a.x), u_input.a)), u_input.a.x))) {
        case 2147483647: {
            let var_0 = !(global0.e.b.x < global4[_wgslsmith_mod_u32(~_wgslsmith_div_u32(~u_input.c.x, u_input.b), 22u)]);
        }
        case -38582: {
        ...
        default: {
            switch (55427) {
                case -32834: {
                    var var_0 = ~select(~(-14331), _wgslsmith_mult_i32(_wgslsmith_clamp_i32(global0.a, -76674, u_input.a.x), u_input.a.x) & u_input.a.x, arg_1.x);
                }
                case -8150: {
                    global3 = array<Struct_1, 2>();
                    fallthrough;
    ...
    var var_0 = Struct_3(_wgslsmith_div_u32(_wgslsmith_clamp_u32(u_input.c.x, func_3(), 1u), _wgslsmith_add_u32(31145u, _wgslsmith_mult_u32(u_input.c.x, global0.d.x) | arg_3)), global2[_wgslsmith_mod_u32(func_4(arg_2, arg_2.x), 28u)]);
    global2 = array<Struct_2, 28>();
    global0 = global2[_wgslsmith_mod_u32(~(u_input.c.x << (var_0.a % 32u)), 28u)];
    let var_1 = _wgslsmith_f_op_f32(step(-1339.0, global4[_wgslsmith_mod_u32(0u, 22u)]));
    return Struct_1(!(!vec4<bool>(global0.c.a.x, arg_0.x, 37573u > arg_3, true)), _wgslsmith_f_op_vec3_f32(_wgslsmith_f_op_vec3_f32(select(_wgslsmith_f_op_vec3_f32(vec3<f32>(966.0, var_0.b.e.b.x, var_0.b.c.b.x) - _wgslsmith_f_op_vec3_f32(var_0.b.e.b * var_0.b.e.b)), _wgslsmith_f_op_vec3_f32(_wgslsmith_f_op_vec3_f32(global0.e.b - global0.e.b) - _wgslsmith_f_op_vec3_f32(-vec3<f32>(global4[_wgslsmith_mod_u32(74200u, 22u)], -900.0, 568.0))), select(all(arg_1), !arg_2.x, !var_0.b.c.a.x))) - vec3<f32>(_wgslsmith_f_op_f32(exp2(-200.0)), var_0.b.e.b.x, 660.0)), 2147483647);
}

fn func_5(arg_0: u32, arg_1: vec3<u32>, arg_2: Struct_2, arg_3: vec4<u32>) -> Struct_1 {
    global2 = array<Struct_2, 28>();
    var var_0 = arg_2.c.b.x;
    let var_1 = firstLeadingBit(reverseBits(abs(max(vec4<i32>(17953, 23064, arg_2.e.c, arg_2.c.c), vec4<i32>(-50709, global0.e.c, 2147483647, arg_2.e.c)))) << (_wgslsmith_div_vec4_u32(~select(vec4<u32>(arg_0, global0.d.x, 1u, 4294967295u), u_input.c, arg_2.c.a.x), u_input.c) % vec4<u32>(32u)));
    global2 = array<Struct_2, 28>();
    global2 = array<Struct_2, 28>();
    return global0.e;
}
...
fn func_1(arg_0: f32, arg_1: vec4<f32>, arg_2: vec2<u32>, arg_3: vec4<f32>) -> Struct_2 {
    let var_0 = Struct_3(u_input.c.x, Struct_2(-1, _wgslsmith_mult_i32(global0.a, (i32(-1) * -13234) << (select(61160u, global0.d.x, global0.e.a.x) % 32u)), func_5(~global0.d.x, ~u_input.c.yxy, Struct_2(-50121 << (4294967295u % 32u), min(global0.c.c, 8028), Struct_1(global0.c.a, vec3<f32>(arg_1.x, arg_0, global0.e.b.x), u_input.a.x), vec3<u32>(5448u, 4294967295u, arg_2.x), func_2(vec4<bool>(false, true, global0.e.a.x, global0.e.a.x), global0.e.a.xz, vec3<bool>(false, global0.e.a.x, true), arg_2.x)), vec4<u32>(5798u, global0.d.x, 0u, arg_2.x)), vec3<u32>(u_input.b ^ ~arg_2.x, firstTrailingBit(~arg_2.x), u_input.c.x), global0.e));
    global4 = array<f32, 22>();
    switch (~(-2147483648 & ~u_input.a.x)) {
        case -27997: {
            switch (~_wgslsmith_sub_i32(firstLeadingBit(u_input.a.x << (68624u % 32u)), reverseBits(-u_input.a.x))) {
                case -19960: {
                    var var_1 = var_0;
                }
                case 16287: {
                    let var_1 = vec3<i32>(_wgslsmith_mult_i32(~(-14444) >> (func_4(func_2(vec4<bool>(global0.c.a.x, var_0.b.c.a.x, true, global0.c.a.x), vec2<bool>(var_0.b.c.a.x, var_0.b.c.a.x), global0.e.a.xxy, 1u).a.zyx, func_2(var_0.b.c.a, var_0.b.e.a.xy, global0.c.a.yzy, 1u).a.x) % 32u), _wgslsmith_dot_vec2_i32(abs(select(u_input.a.yy, u_input.a.yy, vec2<bool>(false, var_0.b.c.a.x))), min(vec2<i32>(-17847, 2147483647), max(u_input.a.yy, vec2<i32>(-11054, -64364))))), abs(u_input.a.x) ^ -2147483648, -6243);
                }
                case 17409: {
                    global2 = array<Struct_2, 28>();
                    fallthrough;
                ...
                default: {
                    var var_1 = _wgslsmith_f_op_vec4_f32(min(_wgslsmith_f_op_vec4_f32(-_wgslsmith_f_op_vec4_f32(min(_wgslsmith_f_op_vec4_f32(step(_wgslsmith_f_op_vec4_f32(-vec4<f32>(arg_1.x, 1171.0, 1620.0, -125.0)), arg_3)), _wgslsmith_f_op_vec4_f32(_wgslsmith_f_op_vec4_f32(step(arg_3, vec4<f32>(615.0, 906.0, 895.0, 914.0))) + _wgslsmith_f_op_vec4_f32(-vec4<f32>(global0.e.b.x, 449.0, arg_3.x, -1280.0)))))), vec4<f32>(-1764.0, arg_1.x, arg_1.x, arg_1.x)));
                }
            }
        }
        default: {
    ...
    let var_1 = var_0;
    return Struct_2(min(_wgslsmith_mod_i32(u_input.a.x, ~(~0)), var_0.b.e.c), u_input.a.x, func_2(select(global0.e.a, vec4<bool>(false, var_0.b.e.a.x, all(var_0.b.c.a.ywy), !true), !(var_0.b.c.a.x & false)), vec2<bool>(all(vec3<bool>(var_1.b.c.a.x, false, var_0.b.c.a.x)) && !false, false), var_0.b.e.a.xzx, ~(~var_0.b.d.x)), ~var_1.b.d, global3[_wgslsmith_mod_u32(1u, 2u)]);
}
...
fn main() {
    loop {
        ...
        var var_0 = global3[_wgslsmith_mod_u32(_wgslsmith_dot_vec3_u32(~vec3<u32>(global0.d.x, ~(~0u), 34500u), vec3<u32>(1u, _wgslsmith_add_u32(_wgslsmith_div_u32(~62663u, _wgslsmith_clamp_u32(u_input.c.x, 33817u, u_input.b)), 4294967295u), u_input.b)), 2u)];
    }
    for (var var_0 = 1; ; var_0 += 1) {
        ...
        let var_1 = select(true, (-1716.0 >= _wgslsmith_f_op_f32(ceil(global0.e.b.x))) && (!true && !select(global0.c.a.x, global0.c.a.x, global0.e.a.x)), true);
    }
    let var_0 = Struct_3(_wgslsmith_clamp_u32(_wgslsmith_mod_u32(9703u, 16307u | 1u), firstLeadingBit(u_input.b), 27508u), func_1(1882.0, vec4<f32>(global0.c.b.x, _wgslsmith_f_op_f32(-734.0 * _wgslsmith_f_op_f32(-1026.0 * global0.e.b.x)), global4[_wgslsmith_mod_u32(~(~0u), 22u)], -240.0), firstTrailingBit(vec2<u32>(4294967295u, 1u)) & (max(vec2<u32>(u_input.c.x, 0u), global0.d.yz) >> (vec2<u32>(74705u, 118638u) % vec2<u32>(32u))), vec4<f32>(_wgslsmith_f_op_f32(_wgslsmith_f_op_f32(ceil(-1069.0)) + _wgslsmith_f_op_f32(f32(-1.0) * -1845.0)), global0.e.b.x, _wgslsmith_f_op_f32(select(-1515.0, global0.c.b.x, true)), 1329.0)));
    for (var var_1: i32; !global0.e.a.x; var_1 += 1) {
        if (LOOP_COUNTERS[6u] >= 1u) {
            break;
        }
        (LOOP_COUNTERS)[6u] = LOOP_COUNTERS[6u] + 1u;
        if (any(select(global1[_wgslsmith_mod_u32(0u, 12u)], vec4<bool>(var_0.b.c.a.x, false, !(!var_0.b.c.a.x), false), global0.e.a.x))) {
            break;
        }
    }
    for (var var_1: i32; all(var_0.b.c.a.zzx); var_1 -= 1) {
        ...
        let var_2 = Struct_2(_wgslsmith_sub_i32(global0.a, abs(-u_input.a.x)), global0.a, func_5(~_wgslsmith_dot_vec3_u32(vec3<u32>(var_0.a, global0.d.x, 0u), _wgslsmith_clamp_vec3_u32(vec3<u32>(4369u, u_input.b, var_0.b.d.x), vec3<u32>(4294967295u, u_input.c.x, 56621u), var_0.b.d)), select(_wgslsmith_add_vec3_u32(vec3<u32>(0u, global0.d.x, u_input.c.x), var_0.b.d) | ~vec3<u32>(61740u, 1u, 4294967295u), var_0.b.d, global0.c.a.xyw), global2[_wgslsmith_mod_u32(~(global0.d.x | ~global0.d.x), 28u)], u_input.c), abs(_wgslsmith_add_vec3_u32(~select(u_input.c.xyw, u_input.c.yyw, global0.c.a.x), vec3<u32>(var_0.b.d.x, ~4294967295u, _wgslsmith_div_u32(global0.d.x, u_input.c.x)))), global0.e);
    }
    let var_1 = func_1(_wgslsmith_f_op_f32(1373.0 * -1148.0), _wgslsmith_f_op_vec4_f32(-_wgslsmith_f_op_vec4_f32(step(_wgslsmith_f_op_vec4_f32(-vec4<f32>(-42.0, global0.e.b.x, -29.0, -106.0)), _wgslsmith_f_op_vec4_f32(-_wgslsmith_f_op_vec4_f32(vec4<f32>(-623.0, global0.c.b.x, var_0.b.e.b.x, -190.0) + vec4<f32>(33.0, -662.0, var_0.b.e.b.x, global0.c.b.x)))))), vec2<u32>(global0.d.x, var_0.a), _wgslsmith_f_op_vec4_f32(-vec4<f32>(_wgslsmith_f_op_f32(trunc(_wgslsmith_f_op_f32(-545.0 + 2051.0))), 1688.0, _wgslsmith_f_op_f32(-_wgslsmith_f_op_f32(f32(-1.0) * -865.0)), var_0.b.e.b.x))).c;
    var var_2 = func_5(global0.d.x, global0.d & var_0.b.d, Struct_2(var_0.b.a, -(-11066 ^ u_input.a.x), func_5(~45617u, global0.d, Struct_2(~global0.e.c, -9978 ^ var_0.b.a, Struct_1(var_0.b.c.a, vec3<f32>(var_1.b.x, var_0.b.c.b.x, 1301.0), 0), _wgslsmith_sub_vec3_u32(u_input.c.ywy, vec3<u32>(global0.d.x, 40222u, u_input.b)), Struct_1(global1[_wgslsmith_mod_u32(1u, 12u)], global0.c.b, var_0.b.e.c)), vec4<u32>(4294967295u, ~1u, ~77087u, firstTrailingBit(global0.d.x))), ~vec3<u32>(var_0.b.d.x, ~u_input.b, 55091u >> (21473u % 32u)), Struct_1(vec4<bool>(!global0.e.a.x, var_0.b.e.a.x && true, all(var_1.a.zy), var_0.b.e.a.x), vec3<f32>(_wgslsmith_f_op_f32(floor(var_1.b.x)), _wgslsmith_f_op_f32(max(var_1.b.x, 969.0)), _wgslsmith_f_op_f32(571.0 - -1062.0)), ~reverseBits(2147483647))), _wgslsmith_mod_vec4_u32(vec4<u32>(~func_4(var_0.b.e.a.wxz, var_0.b.e.a.x), var_0.b.d.x, 0u, func_1(-457.0, _wgslsmith_f_op_vec4_f32(-vec4<f32>(var_1.b.x, var_1.b.x, var_0.b.e.b.x, var_1.b.x)), global0.d.yz, _wgslsmith_f_op_vec4_f32(-vec4<f32>(global0.e.b.x, var_1.b.x, global4[_wgslsmith_mod_u32(var_0.a, 22u)], -1971.0))).d.x), firstLeadingBit(u_input.c)));
    var var_3 = ~u_input.c ^ (abs(min(~u_input.c, abs(vec4<u32>(var_0.a, var_0.a, global0.d.x, 1u)))) << (vec4<u32>(36286u, 0u, func_3(), _wgslsmith_mod_u32(countOneBits(global0.d.x), var_0.a)) % vec4<u32>(32u)));
    let x = u_input.a;
    s_output = StorageBuffer(abs(firstLeadingBit(u_input.a.zz | u_input.a.zx)), _wgslsmith_mult_vec2_i32(select(~vec2<i32>(var_0.b.b, 13184), _wgslsmith_sub_vec2_i32(vec2<i32>(2147483647, -2147483648), ~u_input.a.xz), true), max(~vec2<i32>(global0.c.c, 1) | -vec2<i32>(2147483647, -41561), min(_wgslsmith_div_vec2_i32(vec2<i32>(var_1.c, 15653), u_input.a.zz), max(vec2<i32>(var_2.c, var_1.c), vec2<i32>(global0.a, global0.b))))), countOneBits(1u));
}
